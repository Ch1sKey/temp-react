...
function ProductList({ onHomeClick }) {
    ...
    useEffect(() => {
        ...
        setAddedToCart(prev => {
            const updated = {};
            Object.keys(prev).forEach(plantName => {
                updated[plantName] = cartItemNames.includes(plantName);
            });
            return updated;
        });
    }, [cart]);
    ...
    return (
        <div>
            <div className="navbar">
                ...
                <div className='page-title'> <a href="#" onClick={(e) => handlePlantsClick(e)} style={styleA}>Plants</a></div>
